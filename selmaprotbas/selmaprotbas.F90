...
! !INPUT PARAMETERS:
   ...
   call self%register_state_variable(self%id_dd_si,'dd_si','mmol Si/m3', 'silica detritus', minimum=0.0_rk,vertical_movement=wdz/secs_per_day,no_river_dilution=.true.)
   ...
   call self%add_to_aggregate_variable(type_bulk_standard_variable(name='total_silica',units="mmol/m^3",aggregate_variable=.true.),self%id_dd_si)
   call self%add_to_aggregate_variable(type_bulk_standard_variable(name='total_silica',units="mmol/m^3",aggregate_variable=.true.),self%id_si)
   call self%add_to_aggregate_variable(type_bulk_standard_variable(name='total_silica',units="mmol/m^3",aggregate_variable=.true.),self%id_fl_si)
...
!BOC
   ...
   _LOOP_BEGIN_
      ...
      _GET_(self%id_dd_si,dd_si) ! silica detritus
...
!BOC
 ...
 !   if (self%fluff) then
   ...
   ! Sediment resuspension, detritus settling, bio-resuspension (silica)
